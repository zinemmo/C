Bruno Orengo and Lucas Cadore - Test and Confiability of Systems
==============
We reused the available git repository to create our own. The current task and all future tasks will be inside the _class_exercises_ folder.

Regarding the first task, it is implicit that you add your own implementation of the sort function on the correct file, that being the _sort.c_ file on the _src_ folder of the _class_exercises_ folder of the project.
